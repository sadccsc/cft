    ...
    def forecast():
        ...
        for predictor in config.get('predictorList'):
            if os.path.isfile(predictor):
                ...
                print("sst_arr",sst_arr.shape,predictorStartYr,predictorEndYr,list(range(predictorStartYr,predictorStartYr+sst_arr.shape[0])))
                print("predictand",input_data.shape,predictandstaryr)
                #sys.exit()
